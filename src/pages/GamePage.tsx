        ...
        {isSetup ? (
          ...
          <div className="flex flex-col" style={{ width: BOARD_SIZE }}>
            ...
            >
              ...
              {/* Queen Raid Banner */}
              {((gameState.whiteQueenRaidMoves || 0) > 0 || (gameState.blackQueenRaidMoves || 0) > 0) && (
                <div className="absolute top-2 left-2 right-2 z-40 text-center text-xs text-amber-300 font-serif tracking-wider py-1.5 px-3 bg-amber-950/80 border border-amber-500/40 rounded-xl animate-pulse flex items-center justify-center gap-2 shadow-lg backdrop-blur-sm">
                  <span>👑</span>
                  <span>
                    Queen Raid Active: Move {(gameState.whiteQueenRaidMoves || 0) || (gameState.blackQueenRaidMoves || 0)}/5 (Snapback on 5th)
                  </span>
                </div>
              )}
