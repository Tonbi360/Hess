          ...
          <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-4">
              ...
              <div>
                ...
                <p>Moves 1 square diagonally in any direction (forward or backward, to and fro). Cannot be directly captured: the attack bounces back, and the Jester's owner must choose a non-King friendly piece to sacrifice to save it.</p>
              </div>
            </section>
          </div>
        </ScrollArea>
